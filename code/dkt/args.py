...
def parse_args(mode="train"):
    ...
    parser.add_argument("--pseudo_label_file", default=None, type=str, help="name of best accuracy csv")
    parser.add_argument("--pseudo_epochs", default=3, type=int, help="epoch for pseudo label")
